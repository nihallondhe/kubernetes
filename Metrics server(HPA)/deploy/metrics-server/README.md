...
## Deployment
In order to deploy metrics-server in your kubernetes master machine clone this repo  and run the following command from
...
Error------------------------------------------------------------
get all pods from kube-system namespace - $ kubectl get pod -n kube-system
check if metrics pod is working or not it must required to be working.
